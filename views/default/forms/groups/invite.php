...
$tabs = array();
$forms = '';
if (elgg_get_plugin_setting('users_tab', 'groups_invite', false)) {
	$tabs['users'] = array(
...
if ($entity->canEdit() && (!elgg_get_plugin_setting('require_confirmation', 'groups_invite') || elgg_is_admin_logged_in())) {
